AliAnalysisGrid* CreateAlienHandler(Bool_t isMC,Bool_t fAOD)
 ...
 plugin->SetAPIVersion("V1.1x");
  ...
  //  plugin->SetGridWorkingDir("Phi_03032017_FULL");
  //  plugin->SetGridWorkingDir("v0_03032017_FULL");
  //  plugin->SetGridWorkingDir("v0_04032017_FULL");
  //  plugin->SetGridWorkingDir("v0_30032017");
  //    plugin->SetGridWorkingDir("v0_30032017_2");
  //  plugin->SetGridWorkingDir("v0_30032017_3");

  //    plugin->SetGridWorkingDir("v0_30032017_4");
  //      plugin->SetGridWorkingDir("v0_30032017_5");
  //  plugin->SetGridWorkingDir("v0_04042017_V0QA");
  // plugin->SetGridWorkingDir("v0_04042017_V0QA_nsigma5");
  //    plugin->SetGridWorkingDir("v0_05042017_V0QA_nsigma5");
  //    plugin->SetGridWorkingDir("v0_05042017_V0QA_nsigma5_wgammaconvcut");
  //  plugin->SetGridWorkingDir("v0_1142017_V0QA_nsigma5_wgammaconvcut");
  //  plugin->SetGridWorkingDir("v0_1842017_V0QA");
  //  plugin->SetGridWorkingDir("xml/pass1_CENT_woSDD");

  //        plugin->SetGridWorkingDir("v0_24042017_V0QA");
  //    plugin->SetGridWorkingDir("v0_25042017");
  //      plugin->SetGridWorkingDir("v0_26042017");
  //    plugin->SetGridWorkingDir("SP_02062017");
  //    plugin->SetGridWorkingDir("SP_16062017");
  //      plugin->SetGridWorkingDir("SP_16062017_V0");
  //      plugin->SetGridWorkingDir("SP_16062017_Cascade");
  //       plugin->SetGridWorkingDir("SP_16062017_Phi");
  //   plugin->SetGridWorkingDir("SP_17062017_PID");
  //      plugin->SetGridWorkingDir("SP_17062017");
  //     plugin->SetGridWorkingDir("SP_17062017_V0");

  //plugin->SetGridWorkingDir("SP_21062017");
  //  plugin->SetGridWorkingDir("SP_21062017_Cascade");
  // plugin->SetGridWorkingDir("SP_22062017_Phi");


  //    plugin->SetGridWorkingDir("SP_22062017");
  //     plugin->SetGridWorkingDir("SP_22062017_V0");
  //plugin->SetGridWorkingDir("SP_26062017_Phi");
  //  plugin->SetGridWorkingDir("SP_26062017_Cascade");
  //    plugin->SetGridWorkingDir("SP_29062017");
  //  plugin->SetGridWorkingDir("SP_29062017_Cascade");
  //
  // plugin->SetGridWorkingDir("SP_29062017_Cascade_5");
  //  plugin->SetGridWorkingDir("xml/LHC15n/pass4");
  //  plugin->SetGridWorkingDir("LHC15n_14072017");
  //  plugin->SetGridWorkingDir("LHC15n_16072017");
  //  plugin->SetGridWorkingDir("LHC15n_16072017_1");
  //  plugin->SetGridWorkingDir("LHC15n_16072017_Cas");

  //  plugin->SetGridWorkingDir("SP_Cascade_16qwoSDD");
  //   plugin->SetGridWorkingDir("SP_Cascade_FAST");
  //   plugin->SetGridWorkingDir("xml/hoge");

  //plugin->SetGridWorkingDir("SP_V0_16qFAST");
  //  plugin->SetGridWorkingDir("SP_V0_16qwoSDD");
  // plugin->SetGridWorkingDir("SP_V0_16qwSDD");

  //  plugin->SetGridWorkingDir("SP_V0_16qFAST_Pileup");
  //plugin->SetGridWorkingDir("SP_V0_16qwSDD_Pileup");
  //  plugin->SetGridWorkingDir("SP_V0_16qwoSDD_Pileup");

  //plugin->SetGridWorkingDir("SP_V0_16qFAST_Pileup_Onfly");//But it is wSDD?
  // plugin->SetGridWorkingDir("SP_V0_16qFAST_Pileup_Onfly_1");


  //plugin->SetGridWorkingDir("SP_V0_16qwSDD_Pileup_Onfly");
  //plugin->SetGridWorkingDir("SP_V0_16qFAST_Pileup_Onfly_2");
  //plugin->SetGridWorkingDir("SP_V0_16qwoSDD_Pileup_Onfly");


  //plugin->SetGridWorkingDir("SP_V0_16qFAST_Pileup_Onfly_TOFrequired");

  //  plugin->SetGridWorkingDir("SP_V016qFAST_MVPileup_OFFFly_TOFrequired");

  //plugin->SetGridWorkingDir("SP_V016qFAST_MVPileup_OnFly_TOFrequired");
  //  plugin->SetGridWorkingDir("SP_V016qFAST_MVPileup_offFly_TOFrequired");

  //plugin->SetGridWorkingDir("SP_V016qFAST_MVPileup_OnFly_NoPID");
  //  plugin->SetGridWorkingDir("SP_V016qFAST_MVPileup_offFly_TOFrequredabob0_3");

  //  plugin->SetGridWorkingDir("SP_V016qFAST_MVPileup_OnFly_NoPID_1");

  // plugin->SetGridWorkingDir("SP_V016qFAST_MVPileup_offFly_TOFrequredabob0_3_1");
  //  plugin->SetGridWorkingDir("SP_V016qwoSDD_MVPileup_offFly_TOFrequredabob0_3_1");
  //    plugin->SetGridWorkingDir("SP_V016qwSDD_MVPileup_offFly_TOFrequredabob0_3_1");

  //  plugin->SetGridWorkingDir("SP_V016qwSDD_MVPileup_OnFly_NoPID");
  //  plugin->SetGridWorkingDir("SP_V016qwoSDD_MVPileup_OnFly_NoPID");

  //  plugin->SetGridWorkingDir("Corr_V016qFAST_MVPileup_Offfly_loosecut_diffetarange");
  //plugin->SetGridWorkingDir("Corr_V016qFAST_MVPileup_Offfly_loosecut");
  //  plugin->SetGridWorkingDir("hoge");
  //  plugin->SetGridWorkingDir("CheckAliMultiselection");
  //  plugin->SetGridWorkingDir("ForwardBackward_0824");
  //plugin->SetGridWorkingDir("ForwardBackward_1021");
  //plugin->SetGridWorkingDir("01122017_MC_2");
  //plugin->SetGridWorkingDir("sim/test14_LHC17f2b_fast");
  //  plugin->SetGridWorkingDir("sim/hoge1");
  
      plugin->SetGridWorkingDir("DPMJET_LHC17f2b/19122017");
  //gin->SetGridWorkingDir("sim/hoge8");
  ...
  plugin->SetAnalysisSource("AliAnalysisTaskSEpPbCorrelationsMCYS.cxx");
